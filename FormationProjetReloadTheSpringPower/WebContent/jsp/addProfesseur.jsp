...
<form class="form-inline" method="post" action="http://localhost:8080/PremierProjetWeb/ServletProfesseur"
>
<div class="form-group">

<div>Nom : <input  type="text" name="professeurNom"/> </div>
<div>Prenom : <input type="text" name="professeurPrenom"/> </div>
